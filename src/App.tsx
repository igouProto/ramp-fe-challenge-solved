    ...
    <Fragment>
      <main className="MainContainer">
        ...
        <InputSelect<Employee>
          isLoading={isLoading}
          isEmployeeLoading={employeeUtils.loading}
          ...
          onChange={async (newValue) => {
            ...
            // bug 3 solution: special case for filtering by empty employee
        ...
        <div className="RampGrid">
          ...
          {transactions !== null && (
            ...
            <button
              ...
              disabled={paginatedTransactionsUtils.loading || paginatedTransactions?.nextPage === null || isLoading || !paginatedTransactions}
              onClick={async () => {
                await loadAllTransactions()
              }}
            >View More</button>
